...
export class UserInviteAccept extends React.Component {
    ...
    componentWillMount=()=>{  // компонент родился
        ...
        this.token = this.props.query.token;  // читаем токен из параметров
        this.xr1 = new xreq('user_invite_get', {token: this.token}, this.xrInviteGetHandler);  // загружаем данные инвайта
    }
                ...
                <div className="box-row-nw just-center">
                    <div className="panel panel-default panel-lg">
                        ...
                        <div className="wrap-tb">
                            в компанию <u>{this.invite_data.comp_name}</u>
                        </div>
                        <div className="wrap-tb">
    ...
    getSMS=()=>{
        ...
        this.xr1 = new xreq('user_invite_sms', {token: this.token, phone: phone}, this.xrSmsHandler);  // загружаем данные инвайта
    }
    ...
    accept=()=>{
        ...
        this.xr1 = new xreq('user_invite_accept', p, this.xrAcceptHandler);
    }
