...
export class PriceRequestsBookmarks extends React.Component {
	...
	initProvider =()=> {
    	...
    	this.provider.setParam('type', 'bookmarks');
    	...
    	this.provider.setColumns([{name: "address", title: "Адреса погрузки/разрузки", renderer: PriceRequests__Cell_Address, width: 2},
		    					  ...
		    					  {name: "actions", title: "Действия", renderer: PriceRequests__Cell_Actions, rendererProps: {type: "bookmarks"}}, 
		    					 ]);
